...
/*   Updated: 2023/11/27 18:48:05 by sagemura         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "sortfunc.h"

static int	find_stack_pos_helper(t_list *tmp, int **flag, int flag_n)
{
	int	back_pos;
...
int	find_stack_pos(t_list **stack_a, int **flag, int flag_n)
{
	...
	back_pos = find_stack_pos_helper(tmp, flag, flag_n);
	if (back_pos == 0)
		return (pos);
